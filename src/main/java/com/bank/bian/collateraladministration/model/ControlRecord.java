package com.bank.bian.collateraladministration.model;
...
/**
 * The BIAN control record for this service domain: "Collateral Asset Administrative Plan".
 *
 ...
 * to its asset type (Collateral Asset). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Collateral Asset Administrative Plan";
